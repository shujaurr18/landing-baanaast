    ...
    <header className="bg-white py-3">
      <div className="max-w-[1440px] mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex">
            <button
              ...
              className={`px-4 py-1 rounded-l-full ${
                activeLanguage === "en"
                  ? "bg-gradient-to-r from-[#4CAF50] to-[#2196F3] text-white"
                  : "border"
        ...
        <div className="hidden md:flex items-center">
          ...
          {/* Get Started Button */}
          <button className="px-6 py-2 rounded-full bg-gradient-to-r from-[#4CAF50] to-[#2196F3] text-white">
            {t("header.getStarted")}
          </button>
        </div>
      ...
      >
        ...
        <nav className="flex flex-col items-center gap-8">
          ...
          {/* Get Started Button */}
          <button className="mt-4 px-6 py-2 rounded-full bg-gradient-to-r from-[#4CAF50] to-[#2196F3] text-white">
            {t("header.getStarted")}
          </button>
        </nav>
      </div>
